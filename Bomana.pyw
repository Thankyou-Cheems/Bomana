...
⚠️ 7. 【架构文档】当项目架构发生变更（新增/拆分模块、调整主数据流、核心目录改名），
      必须同步更新 ARCHITECTURE.md

⚠️ 8. [Pitfalls] When failures occur during tasks, record brief causes in PITFALLS.md
      (date/context/symptom/cause/fix)
