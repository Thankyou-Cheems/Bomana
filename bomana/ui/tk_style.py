...
def ink_for(bg: str) -> str:
    """Pick a readable text color for a solid fill, independent of theme."""
    try:
        r, g, b = (int(bg.lstrip("#")[i : i + 2], 16) for i in (0, 2, 4))
    except ValueError, IndexError:
        return "#f2f6fb"
    luminance = (0.299 * r + 0.587 * g + 0.114 * b) / 255
    return "#10293d" if luminance > 0.6 else "#f2f6fb"
