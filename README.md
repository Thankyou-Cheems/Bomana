...
- 可按需打开的打击百科：机场静态结构、EC 任务耐久和炸弹字段参考
- 本机配置与状态恢复
...
| 通道 | 访问方式 | 适合谁 |
|---|---|---|
| **Standard** | 公开、MIT | 需要计时、导航、燃油和离线打击百科 |
| **Lite** | 公开、MIT | 需要极简计时和按需离线参考 |
| **Lite 绿色版** | 公开、免启动器 | 想解压即用，并保留 Lite 百科功能 |
...
Standard 适合需要导航、燃油和更多桌面辅助的玩家；Lite 保留计时、最小界面和
按需打开的百科；Lite 绿色版与 Lite 功能相同，但自带 Python 运行库且无需启动器。超级爆弹版是另
