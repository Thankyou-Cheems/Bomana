...
try {
  ...
  assert.equal(Number(await page.locator(".chart-current").getAttribute("data-immediate")), 1730 * 15 * .86 * .8);
  ...
  assert.equal(await page.locator(".chart-current").getAttribute("data-score"), "800");
  await page.locator("#rewardScoreSlider").focus();
  await page.keyboard.press("ArrowLeft");
  assert.equal(await page.locator("#rewardScore").inputValue(), "775");
  assert.equal(await page.locator(".chart-current").getAttribute("data-score"), "775");
  ...
  assert.equal(await page.locator(".chart-current").count(), 0);
  await page.locator("#rewardScore").fill("600");
