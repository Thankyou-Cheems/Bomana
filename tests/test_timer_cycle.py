...
from bomana.web.control import ValidatedWebCommand, validate_command_payload
...
def test_web_timer_command_is_one_bounded_explicit_target() -> None:
    ...
    assert command == ValidatedWebCommand(
