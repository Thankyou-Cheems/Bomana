...
def test_action_button_variants_share_control_tokens() -> None:
    ...
    # Solid fills pick a readable ink by luminance instead of the theme text.
    assert primary.fg == ink_for("#60aaff")
    assert ink_for("#60aaff") == "#10293d"
    assert ink_for("#672c32") == "#f2f6fb"
